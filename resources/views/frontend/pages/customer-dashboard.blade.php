                    ...
                    <div class="card mt-3">
                        <div class="card-body">
                            ...
                            <ul class="list-group mt-2">
                                <a class="btn btn-sm btn-primary btn-block rounded-0" href="{{ url('/') }}">Home</a>
                                <a class="btn btn-sm btn-outline-primary btn-block rounded-0" href="{{ route('customer.my.order') }}">My Order</a>
